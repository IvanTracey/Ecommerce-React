...
// Manejar inputs
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorOrden("No pudimos registrar tu compra. Probá de nuevo en unos segundos.");
    } finally {
  ...
  return (
    <div className="div-checkout">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {errorOrden && <p className="error-orden">{errorOrden}</p>} 
        <button type="submit" disabled={cargandoOrden}>
          {cargandoOrden ? (<OrbitProgress variant="disc" color="#fff" size="small" />) : ("Confirmar compra"
        )}</button>
      </form>
    </div>
  );
